...
### 1.1 SEO & Routing Overhaul
- [ ] **Replace hash-based routing with proper URLs**
  - Current: `/#/coaches`, `/#/coach/123`
  - Target: `/coaches`, `/coach/123`
  - Impact: Critical for Google indexing and discoverability
  - Options:
    - A) Implement History API routing in current setup
    - B) Migrate to Next.js/Remix for SSR
    - C) Use prerendering service (prerender.io)
  - Requires: Server-side URL rewriting (.htaccess updates)
